...
[Default avatar](#default-avatar) | [No image source](#no-image-source) | [Name as link](#name-as-link) | [Small size](#small-size) | [Inverted style](#inverted-style) | [Alternate shape](#alternate-shape) | [Properties](#properties)
...
Use a different shape when you would like to distinguish between an avatar for a person, and an avatar for another construct, like a team.

<Preview>
  <Story id="components-avatar--alternate-shape" />
</Preview>
