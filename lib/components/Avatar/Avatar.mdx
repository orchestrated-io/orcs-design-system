...
[Default avatar](#default-avatar) | [No image source](#no-image-source) | [Image only](#image-only) | [Icon only](#icon-only) | [Name as link](#name-as-link) | [Small size](#small-size) | [Large size](#large-size) | [Custom size](#custom-size) | [Custom subtitle content](#custom-subtitle-content) | [With local time](#with-local-time) | [Inverted style](#inverted-style) | [Alternate shapes](#alternate-shapes) | [Properties](#properties)
