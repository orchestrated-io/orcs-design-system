...
const Image = styled("img")(
  (props) =>
    css({
      width: props.customSize || themeGet("avatarScale.avatarDefault")(props),
      height: props.customSize || themeGet("avatarScale.avatarDefault")(props),
      flex: "0 0 auto",
...
const HeaderAvatarAction = styled("button")(({ $shape, ...props }) => ({
  position: "absolute",
  top: 0,
  right: 0,
  transform:
    $shape === "circle" ? "translate(-5%, 5%)" : "translate(20%, -20%)",
  width: "36px",
  height: "36px",
  borderRadius: "50%",
  background: "#e6e6e6",
