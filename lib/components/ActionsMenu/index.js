...
const Control = styled.button`
  ...
  width: ${(props) => (props.variant === "circle" ? "35px" : "30px")};
  height: ${(props) => (props.variant === "circle" ? "35px" : "30px")};
  border-radius: ${(props) =>
    props.variant === "circle" ? "50%" : themeGet("radii.2")(props)};
  border: ${(props) =>
    props.variant === "circle" ? "solid 2px" : "solid 1px"};
...
export const ActionsMenuBody = ({
  ...
  let triggerComponent = (
    <Control {...triggerProps} variant={variant} disabled={disabled}>
