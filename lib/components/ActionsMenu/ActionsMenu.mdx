...
[Default actions menu](#default-actions-menu) | [Left offset actions menu](#left-offset-actions-menu) | [Advanced actions menu](#advanced-actions-menu) | [Custom actions menu](#custom-actions-menu) | [Text button actions menu](#text-button-actions-menu) | [Circle variant](#circle-variant) | [Disabled states](#disabled-states) | [Properties](#properties)
...
The ActionsMenu can be disabled by passing the `disabled` prop. When disabled, the trigger button will have a greyed-out appearance and will not respond to clicks. This is useful when the actions are not available in the current context.

<Canvas of={stories.disabledActionsMenu} />

<Canvas of={stories.disabledCircleVariantActionsMenu} />
