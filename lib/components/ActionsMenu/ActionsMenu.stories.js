  ...
  return (
    <>
      <ActionsMenuHeading onClick={reset} canClick={showOther}>
        {showOther && <Icon icon={["fas", "angle-left"]} mr="xs" />} Select
        reason
      </ActionsMenuHeading>
      {!showOther && (
        <>
...
export const circleVariantActionsMenu = () => (
  <ActionsMenu variant="circle">
    <ActionsMenuItem href="https://orchestrated.io/">
      Open details page
    </ActionsMenuItem>
    <BrowserRouter>
...
export const disabledActionsMenu = () => (
...
export const disabledCircleVariantActionsMenu = () => (
  <ActionsMenu variant="circle" disabled>
    <ActionsMenuItem href="https://orchestrated.io/">
      Open details page
    </ActionsMenuItem>
    <BrowserRouter>
