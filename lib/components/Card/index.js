...
const Item = styled.div`
  ...
  padding: ${(props) => themeGet("space.4")(props)};
  box-shadow: ${(props) => themeGet("shadows.boxDefault")(props)};

  ${(props) =>
    props.colour === "primary"
      ? css`
          border-radius: 0 0 ${themeGet("radii.2")(props)}
            ${themeGet("radii.2")(props)};
          border-top: solid 3px ${themeGet("colors.primary")(props)};
        `
      : props.colour === "success"
      ? css`
          border-radius: 0 0 ${themeGet("radii.2")(props)}
            ${themeGet("radii.2")(props)};
          border-top: solid 3px ${themeGet("colors.success")(props)};
        `
      : props.colour === "warning"
      ? css`
          border-radius: 0 0 ${themeGet("radii.2")(props)}
            ${themeGet("radii.2")(props)};
          border-top: solid 3px ${themeGet("colors.warning")(props)};
        `
      : props.colour === "danger"
      ? css`
          border-radius: 0 0 ${themeGet("radii.2")(props)}
            ${themeGet("radii.2")(props)};
          border-top: solid 3px ${themeGet("colors.danger")(props)};
        `
      : props.colour === "greyDark"
      ? css`
          border-radius: 0 0 ${themeGet("radii.2")(props)}
            ${themeGet("radii.2")(props)};
          border-top: solid 3px ${themeGet("colors.greyDarker")(props)};
        `
      : css`
          border-top: 0;
        `};
