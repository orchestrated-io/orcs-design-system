...
const DatePickerLabel = styled.label`
  ...
  font-weight: ${(props) =>
    props.boldLabel ? themeGet("fontWeights.2") : themeGet("fontWeights.1")};
  color: ${(props) =>
    props.invalid
...
const DatePickerContainer = styled.div`
  ...
  .DateRangePickerInput .DateInput:first-child .DateInput_input {
    border-radius: ${(props) =>
      `${themeGet("radii.2")(props)} 0 0 ${themeGet("radii.2")(props)}`};
  }
  .DateRangePickerInput .DateInput:last-child .DateInput_input,
  .DateRangePickerInput__showClearDates .DateInput .DateInput_input,
  .DateRangePickerInput__showClearDates .DateInput .DateInput_input__disabled {
    border-radius: ${(props) =>
      `0 ${themeGet("radii.2")(props)} ${themeGet("radii.2")(props)} 0`};
  }
  ...
  .DateRangePickerInput__showClearDates {
    ...
    .DateInput :has(.DateInput_input:not([value=""])) ~ .SingleDatePickerInput_clearDate,
    .DateInput :has(.DateInput_input:not([value=""])) ~ .DateRangePickerInput_clearDates {
      display: flex;
    }
  }
  ...
  .DateRangePickerInput__showClearDates {
    display: flex;
    align-items: center;
    .DateInput:first-child .DateInput_input:not([value=""]) {
      border-radius: ${(props) =>
        `${themeGet("radii.2")(props)} 0 0 ${themeGet("radii.2")(props)}`};
      }
    }
  ...
  .DateRangePickerInput__showClearDates .DateInput:first-child:has(.DateInput_input:not([value=""])) ~ .DateInput .DateInput_input,
  .DateRangePickerInput__showClearDates .DateInput:first-child ~ .DateInput .DateInput_input:not([value=""]) {
    border-radius: 0;
  }
  .SingleDatePickerInput_clearDate,
  .DateRangePickerInput_clearDates {
          ...
          <>
            {label && (
              ...
              >
                {label}
                {required && (
                  <Small color="danger" ml="xs">
                    *
                  </Small>
                )}
              </DatePickerLabel>
            )}
            <SingleDatePicker id={id} {...pickerProps} />
          </>
        ) : range ? (
          <>
            {label && (
            ...
            <DateRangePicker id={id} {...pickerProps} />
          </>
        ) : null}
      </DatePickerContainer>
    );
