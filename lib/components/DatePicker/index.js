...
const defaultProps = {
  ...
  startDatePlaceholderText: "Start Date dd/mm/yyyy",
  endDateId: END_DATE,
  endDatePlaceholderText: "End Date dd/mm/yyyy",
  disabled: false,
  required: false,
  screenReaderInputMessage: "Type in format dd/mm/yy or use date picker below",
...
DatePicker.propTypes = {
  ...
  /** For specifying width of range inputs (specify units) */
