...
const TagValue = styled.button.attrs((props) => ({
  ...
  border-radius: ${themeGet("tagScale.tagBorderRadius")};
  border-top-right-radius: ${(props) =>
    props.showEdit || props.showInfo || props.showRemove
      ? "0"
      : themeGet("tagScale.tagBorderRadius")};
...
const TagActionIconWrapper = styled(TagValue)`
  border-radius: ${(props) =>
    props.showRemove ? "0" : themeGet("tagScale.tagBorderRadius")};
...
const TagRemoveIconWrapper = styled(TagValue)`
  ...
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
  padding: ${(props) => (props.small ? "2px 6px 2px 5px" : "2px 8px 2px 7px")};
  &:focus {
    z-index: 2;
  }
  ${(props) =>
...
const TagAvatarWrapper = styled.div`
  margin-left: ${(props) =>
    props.small
