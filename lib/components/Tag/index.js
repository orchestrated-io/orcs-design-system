...
class Tag extends React.Component {
  render() {
    const { selected, disabled, hideCross, children } = this.props;
    return (
      <Item selected={selected} disabled={disabled} hideCross={hideCross}>
        {children}
      </Item>
    );
  }
...
Tag.propTypes = {
  /** The content of `Tag` is rendered as a child element */
