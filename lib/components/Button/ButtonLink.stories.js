...
export const loading = () => (
  <Spacer my="3">
    <ButtonLink isLoading href={link}>
      Loading...
    </ButtonLink>
    <ButtonLink isLoading variant="success" href={link}>
      Saving...
    </ButtonLink>
    <ButtonLink isLoading variant="danger" href={link}>
      Deleting...
    </ButtonLink>
  </Spacer>
);
