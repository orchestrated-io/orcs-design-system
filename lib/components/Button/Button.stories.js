...
export const iconOnly = () => (
  <Spacer my="3">
    ...
    <Flex alignItems="center" mt="r">
      <Spacer mr="r">
        <Button iconOnly variant="success" onClick={action("clicked")} width="33px" height="32px">
          <Icon icon={["fas", "check"]} />
        </Button>
        <Button iconOnly variant="successAlternate" onClick={action("clicked")} width="33px" height="32px">
          <Icon icon={["fas", "check"]} />
        </Button>
        <Button iconOnly variant="danger" onClick={action("clicked")} width="33px" height="32px">
          <Icon icon={["fas", "times"]} />
        </Button>
        <Button iconOnly variant="dangerAlternate" onClick={action("clicked")} width="33px" height="32px">
          <Icon icon={["fas", "times"]} />
        </Button>
      </Spacer>
    </Flex>
