...
export const withIcons = ()  => [
  ...
  <TextInput id="textInput10" type="text" label="Phone number" placeholder="E.g. (03) 9451 1786" floating iconLeft={["fas", "phone"]} />,
  ...
  <TextInput fullWidth id="textInput12" type="text" label="What are you looking for?" placeholder="E.g. agile teams" floating iconRight={["fas", "search"]} />
  ];
  withIcons.story = {
  name: "With icons"
}
