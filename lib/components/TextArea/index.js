...
const TextArea = React.forwardRef((props, ref) => {
  ...
  if (inverted) {
    if (valid) {
      labelColor = themeGet("colors.successLightest");
    } else if (invalid) {
      labelColor = themeGet("colors.dangerLightest");
    } else labelColor = themeGet("colors.white");
  } else {
    if (valid) {
      labelColor = themeGet("colors.successDark");
    } else if (invalid) {
      labelColor = themeGet("colors.dangerDark");
    } else labelColor = themeGet("colors.greyDarkest");
  }
