...
const UseWrapperStyles = compose(space, layout);

const UseLabelStyles = compose(space, layout, typography, color);

const UseInputStyles = compose(space, layout, typography, color);
