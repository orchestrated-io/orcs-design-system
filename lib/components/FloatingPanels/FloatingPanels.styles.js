...
export const PanelBarDivider = styled.div`
  flex-grow: 1;
  border-right: 1px solid ${themeGet("colors.greyLighter")};
  cursor: pointer;
  display: flex;
  margin: 4px 2px;
`;
...
export const IconButton = styled.button`
  font-family: ${themeGet("fonts.main")};
  appearance: none;
  background-color: ${({ isExpanded, forceHighlight }) =>
