      ...
      return variant({
        variants: {
          ...
          success: {
            ...
            border: `1px solid ${themeGet("colors.success")(props)}`
          },
          successPending: {
            color: themeGet("colors.success")(props),
            border: `1px solid ${themeGet("colors.success")(props)}`
          ...
          warning: {
            ...
            border: `1px solid ${themeGet("colors.warningDarker")(props)}`
          },
          danger: {
            color: themeGet("colors.danger")(props),
            border: `1px solid ${themeGet("colors.danger")(props)}`
          },
          primaryLight: {
          ...
          primary: {
            ...
            border: `1px solid ${themeGet("colors.primaryDark")(props)}`
          },
          primaryDark: {
            color: themeGet("colors.primaryDarker")(props),
            border: `1px solid ${themeGet("colors.primaryDarker")(props)}`
          },
          secondary: {
            color: themeGet("colors.secondary")(props),
            border: `1px solid ${themeGet("colors.secondary")(props)}`
          }
        }
      });
    } else {
