  ...
  styled(LinkComponent)
    ...
    variant({
      variants: {
        default: {},
        success: {
          bg: themeGet("colors.success"),
          color: themeGet("colors.white"),
          borderColor: themeGet("colors.success"),
          "&:hover": {
            bg: themeGet("colors.successDark"),
            borderColor: themeGet("colors.successDark")
          }
        },
        danger: {
          bg: themeGet("colors.danger"),
          color: themeGet("colors.white"),
          borderColor: themeGet("colors.danger"),
          "&:hover": {
            bg: themeGet("colors.dangerDark"),
            borderColor: themeGet("colors.dangerDark")
          }
        },
        disabled: {
          bg: themeGet("colors.greyLighter"),
          color: themeGet("colors.grey"),
          borderColor: themeGet("colors.greyLighter"),
          "&:hover": {
            bg: themeGet("colors.greyLighter"),
            color: themeGet("colors.grey"),
            borderColor: themeGet("colors.greyLighter")
        ...
        ghost: {
          ...
          borderColor: themeGet("colors.primaryLightest"),
          "&:hover": {
            bg: themeGet("colors.primaryLighter"),
            borderColor: themeGet("colors.primaryLighter"),
