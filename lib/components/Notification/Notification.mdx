...
<Canvas of={stories.basicNotification} />

## Alternate Colours

<Canvas of={stories.colourNotification} />

## Text-only

<Canvas of={stories.textOnlyNotification} />

## Close Disabled

<Canvas of={stories.closeDisabledNotification} />

## Loading

<Canvas of={stories.loadingNotification} />

## Alternate Style

<Canvas of={stories.altStyleNotification} />

## Floating

This notification will appear on the bottom right corner of the browser's screen.

<Canvas of={stories.floatingNotification} />
...
<Canvas of={stories.centeredNotification} />
