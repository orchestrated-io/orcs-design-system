...
class Notification extends React.Component {
  ...
  render() {
    const { icon, colour, floating, children, top, right, bottom, left, centered } = this.props;
    const { dismissed } = this.state;
    return (!dismissed &&
      <Item colour={colour} floating={floating} top={top} right={right} bottom={bottom} left={left} centered={centered}>
