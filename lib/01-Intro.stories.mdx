...
# ORCS Design System by Orchestrated

## featuring Styled System + Styled Components

[GitHub repository](https://github.com/orchestrated-io/orca-design-system) | [Deployed on GitHub Pages](https://orchestrated-io.github.io/orca-design-system/) | [Development guide](https://orchestrated.atlassian.net/wiki/spaces/OR/pages/1073938514/Working+on+ORCS+design+system) | [Orchestrated](https://orchestrated.io/)
...
The [ORCS Storybook](https://styleguide.orchestrated.io/?path=/docs/intro--page) contains documentation for each component, including code examples and props tables.
