const orchestratedColours = {
  ...
  greyDarker:
    "#2F3234" /* Usually used for UI elements like backgrounds, muted tex, icons, dividers or borders */,
  greyDark:
    "#52595D" /* Usually used for UI elements like backgrounds, muted tex, icons, dividers or borders */,
  grey:
    "#90979A" /* Usually used for UI elements like backgrounds, muted tex, icons, dividers or borders */,
  greyLight:
    "#B5BBBE" /* Usually used for UI elements like backgrounds, muted tex, icons, dividers or borders */,
  greyLighter:
    "#D7DDDF" /* Usually used for UI elements like backgrounds, muted tex, icons, dividers or borders */,
  greyLightest:
    "#F2F5F5" /* Usually used for UI elements like backgrounds, muted tex, icons, dividers or borders */,
