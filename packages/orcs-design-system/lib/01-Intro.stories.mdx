...
### Orchestrated's internal design system using react and styled-components
...
- Ensure the global styles and theme provider are included in your application like below:

```
  import { systemtheme, GlobalStyles } from "orca-design-system";
