...
<Preview>
  <Story name="Default Expandable">{stories.defaultExpandable()}
  </Story>
</Preview>
...
<Preview>
  <Story name="Open Expandable">{stories.openExpandable()}
  </Story>
</Preview>
...
<Preview>
  <Story name="Expandable with subtitle">{stories.expandableWithSubtitle()}
  </Story>
</Preview>
...
<Preview>
  <Story name="Expandable with badge">{stories.expandableWithBadge()}
  </Story>
</Preview>
