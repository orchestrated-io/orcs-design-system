...
<Preview>
  <Story name="Default Icon">{stories.defaultIcon()}</Story>
</Preview>

## Colours

<Preview>
  <Story name="Coloured Icon">{stories.colouredIcon()}</Story>
</Preview>

## Size

<Preview>
  <Story name="Icon Size">{stories.iconSize()}</Story>
</Preview>
...
<Preview>
  <Story name="Inverted">
    <Box bg="greyDarker" p="r" width="100%">
...
<Preview>
  <Story name="Animated Icons">{stories.animatedIcons()}</Story>
</Preview>

## Transforms and rotations

<Preview>
  <Story name="Transforms and rotations">
    {stories.transformsAndRotations()}
  </Story>
</Preview>
