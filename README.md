...
This repository runs on [https://lerna.js.org/](Lerna). There are two packages installed:
* `orca-design-system`: Version 1.1.13, used by our apps.
* `orcs-design-system`: Currently in development, being ported to Storybook, refactored, and redesigned.
...
#### View style guide on Storybook

`lerna run storybook`

#### View style guide on Styleguidist (old version)
